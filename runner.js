...
const FINAL_V930_VERSION = 'v10.1.2-proof-scope-server-candle-bootstrap';
...
async function collectReport() {
  ...
  if (!safeArray(lastDiscoveryOutputView?.rows).length && n(report?.data?.candlesLoaded || report?.candlesLoaded || 0, 0) > 0) {
