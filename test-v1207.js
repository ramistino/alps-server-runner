...
class TestStorage {
  ...
  async writeJsonAtomic(file,payload){this.assertV12Write(file);await fsp.mkdir(path.dirname(file),{recursive:true});await fsp.writeFile(file,JSON.stringify(payload,null,2));}
